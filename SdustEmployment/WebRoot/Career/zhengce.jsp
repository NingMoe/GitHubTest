				...
				<div class="sub">
					<div class="sub_top">
						<table width="701" height="47" border="0" cellspacing="0"
							cellpadding="0">
							<tr>
								<td width="351" background="../images/zhengce_12.jpg">&nbsp;</td>
								<td width="350" background="../images/sub1_13.jpg"
									class="tablea" style="color:#FFF;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp; 您所在的位置：<a href="../servlet/IndexServlet">首页</a> &gt;&gt; 就业政策</td>
							</tr>
						</table>
					</div>
					<div class="sub_bottom">
						<%
							List<StuQuery> stuQuerys = (List<StuQuery>) request.getAttribute("stuQuerys");
						%>
						<ul>
							<%
							...
							%>
							<li><a
								href="../servlet/PolicyServlet?flag=content&ID=<%=stuQuery.getiD()%>"><%=stuQuery.getReleaseTime().substring(0, 10) %>&nbsp;<%=stuQuery.getTitle()%></a>
						...
						<div class="fenye">
							...
							&nbsp;<a
								href="../servlet/PolicyServlet?flag=index&countPageNow=1">首页</a>
							&nbsp;
							<%
							...
							%>
							<a
								href="../servlet/PolicyServlet?flag=index&countPageNow=<%=(Integer) request.getSession().getAttribute(
						...
						"countPageNow") + 1%>">下一页</a>&nbsp;
							...
							%>
							<a
								href="../servlet/PolicyServlet?flag=index&countPageNow=<%=(Integer) request.getSession().getAttribute("countPage")%>">尾页</a>&nbsp;
