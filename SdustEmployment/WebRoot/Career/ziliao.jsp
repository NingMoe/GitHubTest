				...
				<div class="sub">
					<div class="sub_top">
						<table width="701" height="47" border="0" cellspacing="0"
							cellpadding="0">
							<tr>
								<td width="351" background="../images/ziliao_12.jpg">&nbsp;</td>
								<td width="350" background="../images/sub1_13.jpg"
									class="tablea" style="color:#FFF;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 您所在的位置：<a href="../servlet/IndexServlet">首页</a> &gt;&gt; 相关资料</td>
							</tr>
						</table>
					</div>
					...
					<div class="sub_bottom">
						...
						<ul>
							...
							%>
							<li><a
								href="../servlet/DataServlet?flag=content&ID=<%=stuQuery.getiD()%>"><%=stuQuery.getReleaseTime() %>&nbsp;<%=stuQuery.getTitle()%></a>
						...
						<div class="fenye">
							...
							&nbsp;<a
								href="../servlet/DataServlet?flag=index&countPageNow=1">首页</a>
							&nbsp;
							<%
							...
							%>
							<a
								href="../servlet/DataServlet?flag=index&countPageNow=<%=(Integer) request.getSession().getAttribute(
						...
						"countPageNow") + 1%>">下一页</a>&nbsp;
							...
							%>
							<a
								href="../servlet/DataServlet?flag=index&countPageNow=<%=(Integer) request.getSession().getAttribute("countPage")%>">尾页</a>&nbsp;
