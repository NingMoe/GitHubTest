			...
			<div class="rightdiv" id="body_1">
				<div class="content">
					<div class="content_top">
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								...
								<td width="98%" valign="bottom">您的位置：<a href="../servlet/IndexServlet">首页</a>
									&gt;&gt; <a href="../servlet/ProcessServlet?flag=main">就业流程</a>  &gt;&gt; 全文</td>
							</tr>
						</table>
					</div>
					...
					<div class="content_bottom">
						...
						<div style="padding:10px 30px; text-align:center;">作者：<%=stuQuery.getAuthor() %>
							&nbsp;&nbsp;&nbsp; &nbsp;来源：<%=stuQuery.getOrigin() %>&nbsp; &nbsp; &nbsp; &nbsp;
							更新时间:<%=stuQuery.getReleaseTime() %> &nbsp; &nbsp;&nbsp; &nbsp; 点击阅读量：<%=stuQuery.getPv() %></div>
